...
public class ParceriaVisualizarDto {
	...
	public ParceriaVisualizarDto() {
		
	}
	
	

	public ParceriaVisualizarDto(Integer id, Date data, String imagem, String titulo, String descricao,
