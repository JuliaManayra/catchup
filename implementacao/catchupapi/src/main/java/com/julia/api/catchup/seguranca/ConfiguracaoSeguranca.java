...
public class ConfiguracaoSeguranca extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.POST, "/perfis").hasRole("ADMINISTRADOR")
		...
		.antMatchers(HttpMethod.GET, "/aviso/**").hasAnyRole("ADMINISTRADOR","COLABORADOR")
		.antMatchers(HttpMethod.POST, "/aviso/salvar").hasRole("ADMINISTRADOR")
		.antMatchers(HttpMethod.PUT, "/aviso/**").hasRole("ADMINISTRADOR")
		.antMatchers(HttpMethod.GET, "/post/**").hasAnyRole("ADMINISTRADOR","COLABORADOR")
		.antMatchers(HttpMethod.POST, "/post/**").hasAnyRole("ADMINISTRADOR","COLABORADOR")
		.antMatchers(HttpMethod.PUT, "/post/**").hasAnyRole("ADMINISTRADOR","COLABORADOR")
		.antMatchers(HttpMethod.GET, "/parceria/**").hasAnyRole("ADMINISTRADOR","COLABORADOR")
		.antMatchers(HttpMethod.POST, "/parceria/salvar").hasRole("ADMINISTRADOR")
		.antMatchers(HttpMethod.PUT, "/parceria/**").hasRole("ADMINISTRADOR")
		.antMatchers(HttpMethod.GET, "/areAtuacao/**").hasAnyRole("ADMINISTRADOR","COLABORADOR")
		.antMatchers(HttpMethod.POST, "/areAtuacao/salvar").hasRole("ADMINISTRADOR")
		.antMatchers(HttpMethod.PUT, "/areAtuacao/**").hasRole("ADMINISTRADOR")
